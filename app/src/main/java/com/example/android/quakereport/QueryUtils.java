...
public final class QueryUtils {
    ...
    private static final String USGS_JSON_QUERY = "https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&eventtype=earthquake&orderby=time&minmag=6&limit=10";
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            JSONObject root = new JSONObject(USGS_JSON_QUERY);
